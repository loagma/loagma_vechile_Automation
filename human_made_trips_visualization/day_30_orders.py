...
# Path to your user sheet file for Day 30
USER_SHEET_PATH = os.path.join(os.path.dirname(__file__), "yocm27jhm8_UserSheet.txt")

db = SessionLocal()

try:
    print("=== Reading Day 30 User Sheet ===\n")
    ...
    print(f"Found {len(order_ids)} order IDs in Day 30 user sheet\n")
    ...
    <div style="position: fixed; 
        ...
        <h4 style="margin-top:0;">Day 30 Trip Summary</h4>
    ...
    # Save map
    map_filename = 'day_30_trips_map.html'
